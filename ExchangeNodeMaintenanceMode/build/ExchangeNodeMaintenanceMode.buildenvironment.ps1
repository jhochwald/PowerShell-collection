...
if ((Get-Variable 'BuildEnv' -ErrorAction:SilentlyContinue) -eq $null) {
    $Script:BuildEnv = New-Object -TypeName PSObject -Property @{
        ...
        ModuleWebsite = 'https://github.com/jhochwald/PowerShell-collection'
        ModuleCopyright = "(c) $((get-date).Year.ToString()) Joerg Hochwald. All rights reserved."
        ModuleLicenseURI = 'https://github.com/jhochwald/PowerShell-collection/LICENSE.md'
